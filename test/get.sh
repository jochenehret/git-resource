...
it_can_get_with_git_ignore_flag_default() {
  local repo=$(init_repo)
  local dest=$TMPDIR/destination
...
it_can_get_with_git_ignore_flag_true() {
  local repo=$(init_repo)
  local dest=$TMPDIR/destination
...
run it_can_get_with_git_ignore_flag_default
run it_can_get_with_git_ignore_flag_true
